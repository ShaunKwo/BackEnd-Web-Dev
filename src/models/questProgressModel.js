...
module.exports.createNewQuestProgress = (data, callback) => {
    const SQL_STATEMENT = `
        ...
        SELECT user_id, quests.quest_id, quest_completion_date, quest_notes, items.item_id, item_name,items.description, planets.planet_id,planet_name, planets.description
